 ...
 * resizing the child elements vertically when the VBoxLayout is bigger or smaller
 * than the sum of its children.
 * 
 * None - Children will not be resized vertically, extra space is empty. This defaults
 ...
 *        original size.
 * ForcedEven - The space in the VBoxLayout is divided evenly among all children.
 ...
 * 
 * Child elements can be instructed to fill remaining horizontal space or, by default,
 * remain their original horizontal size. By default items that do not fill the
 * horizontal size of the VBoxLayout will be aligned to the left, the default alignment
 * can be changed in the constructor and overridden by each added child. Additional
 * alignments are Right and Center.
 * 
...
public class VBoxLayout extends AbstractGuiComponent implements GuiLayout, Cloneable {
    ...
    /**
     * Constructs a new <code>VBoxLayout</code> elements will not stretch to fill
     * remaining horizontal space and are left aligned.
     * 
     * @param margin Amount of space between elements.
     * @param vFillMode <code>FillMode</code> indicating how vertical stretching and
     ...
     * when they are added.
     * 
     * @see #addChild(com.jme3.scene.Node, chet2.ui.components.VBoxLayout.HAlign, boolean) 
     */
    ...
    /**
     * Sets the method by which child elements will be grown or shrunk vertically when
     * the <code>VBoxLayout</code> is bigger or smaller than the sum of element heights.
     * 
     * None - Children will not be resized vertically, extra space is empty. This defaults
     *        to Proportional when children need to shrink.
     * Even - Remaining space is divided evenly among the children or the children are
     ...
     * <code>VBoxLayout</code> should be stretched to fill the width
     * by default. This can be overridden when adding elements.
     * 
     ...
     * @param fillWidth True if this element should fill remaining horizontal space.
